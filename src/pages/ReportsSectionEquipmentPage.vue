<template>
  <q-layout id="q-app" view="lHh Lpr lFf">
    ...
    <q-page-container style="margin-top: -0.5rem; padding-bottom: 3.5rem">
      <router-view /> 
      <ReportsEquipmentSection/>
    </q-page-container> 
  </q-layout>
</template>

<script>
import ReportsEquipmentSection from "../components/ReportsEquipmentSection.vue";
